...
xref:src/main/asciidoc/first-in-hospital.adoc[第一次住院]  :: 2026/07/29
xref:src/main/asciidoc/groovy.adoc[使用Groovy开发jsr223脚本]  :: 2026/08/03
xref:src/main/asciidoc/resignation.adoc[离职了]  :: 2026/08/04